...
export default {
  ...
  props: {
    ...
    buttonTitleMessage: String, // Сообщение которое мы выводим при наведении на кнопку закрытия (Убрать автора / убрать тег и тд)
    title: String // Сообщение которое мы выводим при наведении на саму чипсу
  },
